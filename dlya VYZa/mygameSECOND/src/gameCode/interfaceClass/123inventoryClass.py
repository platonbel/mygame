import pygame
from gameCode import interfaceClass, shapeClass, textClass
...
class Inventory():
    ...
    def __init__(self, screen):
        ...
        self.inventoryslots = {
            ...
            '1': (shapeClass.defaultShape.Shape(position=(82, screen.get_height()-82), side='center', layer=2, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer), 
            textClass.defaultText.Text(side = 'bottomright', layer=3, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer)),
            
            '2': (shapeClass.defaultShape.Shape(position=(186, screen.get_height()-82), side='center', layer=2, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer), 
            textClass.defaultText.Text(side = 'bottomright', layer=3, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer)),
            
            '3': (shapeClass.defaultShape.Shape(position=(290, screen.get_height()-82), side='center', layer=2, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer), 
            textClass.defaultText.Text(side = 'bottomright', layer=3, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer)),
            
            '4': (shapeClass.defaultShape.Shape(position=(394, screen.get_height()-82), side='center', layer=2, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer), 
            textClass.defaultText.Text(side = 'bottomright', layer=3, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer)),
            
            '5': (shapeClass.defaultShape.Shape(position=(498, screen.get_height()-82), side='center', layer=2, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer),
            textClass.defaultText.Text(side = 'bottomright', layer=3, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer)),

            '6': (shapeClass.defaultShape.Shape(position=(82, screen.get_height()-426), side='center', layer=2, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer), 
            textClass.defaultText.Text(side = 'bottomright', layer=3, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer)),
            
            '7': (shapeClass.defaultShape.Shape(position=(186, screen.get_height()-426), side='center', layer=2, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer), 
            textClass.defaultText.Text(side = 'bottomright', layer=3, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer)),
            
            '8': (shapeClass.defaultShape.Shape(position=(290, screen.get_height()-426), side='center', layer=2, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer), 
            textClass.defaultText.Text(side = 'bottomright', layer=3, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer)),
            
            '9': (shapeClass.defaultShape.Shape(position=(394, screen.get_height()-426), side='center', layer=2, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer), 
            textClass.defaultText.Text(side = 'bottomright', layer=3, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer)),
            
            '10': (shapeClass.defaultShape.Shape(position=(498, screen.get_height()-426), side='center', layer=2, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer),
            textClass.defaultText.Text(side = 'bottomright', layer=3, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer)),
        
            '11': (shapeClass.defaultShape.Shape(position=(82, screen.get_height()-322), side='center', layer=2, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer), 
            textClass.defaultText.Text(side = 'bottomright', layer=3, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer)),
            
            '12': (shapeClass.defaultShape.Shape(position=(186, screen.get_height()-322), side='center', layer=2, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer), 
            textClass.defaultText.Text(side = 'bottomright', layer=3, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer)),
            
            '13': (shapeClass.defaultShape.Shape(position=(290, screen.get_height()-322), side='center', layer=2, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer), 
            textClass.defaultText.Text(side = 'bottomright', layer=3, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer)),
            
            '14': (shapeClass.defaultShape.Shape(position=(394, screen.get_height()-322),side='center', layer=2, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer), 
            textClass.defaultText.Text(side = 'bottomright', layer=3, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer)),
            
            '15': (shapeClass.defaultShape.Shape(position=(498, screen.get_height()-322), side='center', layer=2, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer), 
            textClass.defaultText.Text(side = 'bottomright', layer=3, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer)),
            
            '16': (shapeClass.defaultShape.Shape(position=(82, screen.get_height()-218), side='center', layer=2, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer),
            textClass.defaultText.Text(side = 'bottomright', layer=3, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer)), 

            '17': (shapeClass.defaultShape.Shape(position=(186, screen.get_height()-218), side='center', layer=2, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer),
            textClass.defaultText.Text(side = 'bottomright', layer=3, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer)),

            '18': (shapeClass.defaultShape.Shape(position=(290, screen.get_height()-218), side='center', layer=2, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer), 
            textClass.defaultText.Text(side = 'bottomright', layer=3, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer)),
            
            '19': (shapeClass.defaultShape.Shape(position=(394, screen.get_height()-218), side='center', layer=2, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer), 
            textClass.defaultText.Text(side = 'bottomright', layer=3, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer)),
            
            '20': (shapeClass.defaultShape.Shape(position=(498, screen.get_height()-218), side='center', layer=2, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer), 
            textClass.defaultText.Text(side = 'bottomright', layer=3, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer)),
            
        }
        
        self.tempitemslot = (shapeClass.defaultShape.Shape(side='center', layer=2, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer), 
            textClass.defaultText.Text(side = 'bottomright', layer=3, privateLayer=interfaceClass.instances.interfaceLayer.defaultLayer))
